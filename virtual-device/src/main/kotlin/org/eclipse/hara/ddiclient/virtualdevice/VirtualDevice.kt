...
class VirtualDevice(private val configuration: Configuration = Configuration.default()) {
    ...
    private fun getClient(
        ...
        return HaraClientDefaultImpl().apply {
            init(
                ...
                directoryForArtifactsProvider = DirectoryForArtifactsProviderImpl(configuration, clientData.controllerId),
